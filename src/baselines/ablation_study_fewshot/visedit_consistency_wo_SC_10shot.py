...
from prompts.ablation_study_10shot.visedit_consistency_prompt import CLAUSE_LOCATION_PROMPT,SCHEMA_LINKING_PROMPT, GENERATION_PROMPT, MERGE_PROMPT
...
class Model:
    ...
    def generate(self, args, df_row):
        ...
        correct_clause = self.chatbot.chat(clause_generation_msg, **self.pipeline_kwargs)
        ...
        answer = self.chatbot.chat(messages, **self.pipeline_kwargs)   
